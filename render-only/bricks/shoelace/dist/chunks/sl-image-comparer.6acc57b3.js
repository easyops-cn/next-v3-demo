...
`,s=n(6200),a=n(7282),l=n(1807),c=n(8379),d=n(5710),h=n(5381),u=n(8424),g=n(453),v=class extends u.P{constructor(){super(...arguments),this.localize=new c.V(this),this.position=50}handleDrag(e){const{width:t}=this.base.getBoundingClientRect(),n="rtl"===this.localize.dir();e.preventDefault(),(0,s.o)(this.base,{onMove:e=>{this.position=parseFloat((0,l.u)(e/t*100,0,100).toFixed(2)),n&&(this.position=100-this.position)},initialEvent:e})}handleKeyDown(e){const t="ltr"===this.localize.dir(),n="rtl"===this.localize.dir();if(["ArrowLeft","ArrowRight","Home","End"].includes(e.key)){const r=e.shiftKey?10:1;let i=this.position;e.preventDefault(),(t&&"ArrowLeft"===e.key||n&&"ArrowRight"===e.key)&&(i-=r),(t&&"ArrowRight"===e.key||n&&"ArrowLeft"===e.key)&&(i+=r),"Home"===e.key&&(i=0),"End"===e.key&&(i=100),i=(0,l.u)(i,0,100),this.position=i}}handlePositionChange(){this.emit("sl-change")}render(){const e="rtl"===this.localize.dir();return i.y`
      <div
        part="base"
        id="image-comparer"
    ...
    `}};v.styles=o,(0,g.u2)([(0,u.i)(".image-comparer")],v.prototype,"base",2),(0,g.u2)([(0,u.i)(".image-comparer__handle")],v.prototype,"handle",2),(0,g.u2)([(0,u.e2)({type:Number,reflect:!0})],v.prototype,"position",2),(0,g.u2)([(0,d.Y)("position",{waitUntilFirstUpdate:!0})],v.prototype,"handlePositionChange",1),v=(0,g.u2)([(0,u.e)("sl-image-comparer")],v),n(1862),n(9940),n(9191),n(836),n(2759),n(1939),n(4370)}}]);
//# sourceMappingURL=sl-image-comparer.6acc57b3.js.map